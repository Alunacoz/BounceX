...
func _init_state() -> void:
	if _wv_scroll:
		$VBox/Scrolling/ScrollingActive.set_pressed_no_signal(Data.config.get_value("waveform", "scroll_active", true))
		$VBox/Scrolling/Peak/ShowPeak.set_pressed_no_signal(_wv_scroll.show_peak)
		$VBox/Scrolling/Peak/PeakColorPicker.color = _wv_scroll._peak_col
		$VBox/Scrolling/RMS/ShowRMS.set_pressed_no_signal(_wv_scroll.show_rms)
		$VBox/Scrolling/RMS/RMSColorPicker.color = _wv_scroll._rms_col
	if _wv_static:
		$VBox/Static/StaticActive.set_pressed_no_signal(Data.config.get_value("waveform", "static_active", true))
		$VBox/Static/Peak/ShowPeak.set_pressed_no_signal(_wv_static.show_peak)
		$VBox/Static/Peak/PeakColorPicker.color = _wv_static._peak_col
		$VBox/Static/RMS/ShowRMS.set_pressed_no_signal(_wv_static.show_rms)
